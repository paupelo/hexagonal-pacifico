...
const SCHEDULE = [
  {
    ...
    type: 'liga',
    matches: [
      { id: 'j1-1', time: '7:00', home: 'Colegio Francés', away: 'Deportivo Amarillo' },
      { id: 'j1-2', time: '8:15', home: 'Cludsa FC', away: 'New Generation PPFC' },
      { id: 'j1-3', time: '9:30', home: 'Panamá Pacífico Residentes FC', away: 'Independiente Chorrera' },
    ],
  },
  {
    round: 2,
    ...
    type: 'liga',
    matches: [
      { id: 'j2-1', time: '7:00', home: 'Cludsa FC', away: 'Independiente Chorrera' },
      { id: 'j2-2', time: '8:15', home: 'Panamá Pacífico Residentes FC', away: 'Deportivo Amarillo' },
      { id: 'j2-3', time: '9:30', home: 'Colegio Francés', away: 'New Generation PPFC' },
    ],
  },
  {
    round: 3,
    ...
    type: 'liga',
    matches: [
      { id: 'j3-1', time: '7:00', home: 'Colegio Francés', away: 'Independiente Chorrera' },
      { id: 'j3-2', time: '8:15', home: 'Panamá Pacífico Residentes FC', away: 'Cludsa FC' },
      { id: 'j3-3', time: '9:30', home: 'Deportivo Amarillo', away: 'New Generation PPFC' },
    ],
  },
  {
    round: 4,
    ...
    type: 'liga',
    matches: [
      { id: 'j4-1', time: '7:00', home: 'Deportivo Amarillo', away: 'Independiente Chorrera' },
      { id: 'j4-2', time: '8:15', home: 'Panamá Pacífico Residentes FC', away: 'Colegio Francés' },
      { id: 'j4-3', time: '9:30', home: 'Cludsa FC', away: 'New Generation PPFC' },
    ],
  },
  {
    round: 5,
    ...
    type: 'liga',
    matches: [
      { id: 'j5-1', time: '7:00', home: 'New Generation PPFC', away: 'Independiente Chorrera' },
      { id: 'j5-2', time: '8:15', home: 'Cludsa FC', away: 'Colegio Francés' },
      { id: 'j5-3', time: '9:30', home: 'Panamá Pacífico Residentes FC', away: 'Deportivo Amarillo' },
    ],
  },
  {
    round: 6,
